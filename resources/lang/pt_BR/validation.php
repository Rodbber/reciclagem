...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'celular' => [
            'required_if' => 'O celular não pode estar vazio se o telefone também estiver'
        ],
        /*'tipos.*.tipo_servico_id' => [
            'numeric' => 'Um serviço deve ser selecionado'
        ],
        */
        /* 'celular' => [
            'required_if' => 'O celular não pode estar vazio se o telefone também estiver'
        ...
        'telefone' => [
            'required_if' => 'O telefone não pode estar vazio se o celular também estiver'
        ], */
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'cep' => 'CEP',
        'cnpj' => 'CNPJ',
        'tipos.*.tipo_servico_id' => 'tipo de serviço',
        'tipos.*.valor' => 'valor do serviço',
        'servicos.*.servico_id' => 'tipo de serviço',
